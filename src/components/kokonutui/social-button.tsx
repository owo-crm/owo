...
import { AtSign, Link, MessageCircle, SendHorizontal } from "lucide-react";
...
export default function SocialButton({
  ...
  const shareButtons = [
    { icon: MessageCircle, label: "Open Telegram" },
    { icon: AtSign, label: "Follow updates" },
    { icon: SendHorizontal, label: "Share quickly" },
